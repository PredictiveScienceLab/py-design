...
!f2py real*8 intent(in,out),depend(dim_num),dimension(dim_num) :: quasi
...
!f2py integer intent(optional) :: skip = 0
!f2py real*8 intent(out),depend(m,n),dimension(m,n) :: r
...
!f2py integer intent(in) :: dim_num
!f2py integer intent(out) :: tau_sobol
